...
public class SerialisableInput : IMessageSerializable
{
    ...
    public OneOf<bool, float, Vector2, Vector3, Quaternion> UpdateInput(InputIdentifier id, Message msg) => Serialization.UpdateInput(input: ref Input, id: id, msg: msg);
    ...
    public void Deserialize(Message msg) => Input = new HandInput
    {
