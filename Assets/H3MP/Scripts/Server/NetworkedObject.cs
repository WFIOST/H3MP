...
namespace H3MP.Server
{
	...
	public class NetworkedObject : IMessageSerializable, IEquatable<NetworkedObject>
	{
		...
		{
			message.Add(ID).Add(ObjectID).Add(Transform).AddVector3(Velocity);
		}
		...
		{
			return ReferenceEquals(objA: this, objB: obj) || Equals(obj);
		}
		...
		public static bool operator ==(NetworkedObject left, NetworkedObject right)
		{
