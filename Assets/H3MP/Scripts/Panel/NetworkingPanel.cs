...
namespace H3MP
{
    ...
    public class NetworkingPanel : BaseUnityPlugin
    {
        ...
        public NetworkingPanel()
        {
            ...
            Server = new Server.Server(tickRefreshRate: TickRefreshRate.Value);
        }
        ...
        {
            NetworkManager.Instance.Connection.Update();
            Server.Update();
        }
        ...
        public void Connect()
        {
            NetworkManager.Instance.Connection.Connect(IPaddress);
        ...
        {
            Server.Start(port: Port.Value, maxClients: PlayerCount.Value);
